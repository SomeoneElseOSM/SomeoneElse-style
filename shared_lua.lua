...
-- ----------------------------------------------------------------------------
   if (((  passedt.boundary      == "protected_area"                                                      )   and
	 ...
	 ( passedt.designation   == "common;site_of_special_scientific_interest;national_nature_reserve" )    or
...
-- ----------------------------------------------------------------------------
   if ((  passedt["seamark:type"]                          == "small_craft_facility"  ) and
       (  passedt["seamark:small_craft_facility:category"] == "toilets"               ) and
       (( passedt.amenity                                  == nil                    )  or
        ( passedt.amenity                                  == ""                     ))) then
      passedt.amenity = "toilets"
   end
...
-- ----------------------------------------------------------------------------
   if ((  passedt.amenity == "restaurant"                  )  and
      ...
      passedt.amenity = "restaurant_italian_"
      append_wheelchair_t( passedt )
   end
...
-- ----------------------------------------------------------------------------
   if ((( passedt.amenity == "restaurant"                        )  or
      ...
      passedt.amenity = "restaurant_fish_and_chips_"
      append_wheelchair_t( passedt )
   end
   ...
   if ((  passedt.amenity == "restaurant"            )  and
      ...
      passedt.amenity = "restaurant_sandwich_"
      append_wheelchair_t( passedt )
   end
   ...
   if ((  passedt.amenity == "restaurant"              )  and
      ...
      passedt.amenity = "restaurant_chicken_"
      append_wheelchair_t( passedt )
   end
   ...
   if ((  passedt.amenity == "restaurant"              ) and
      ...
      passedt.amenity = "restaurant_mexican_"
      append_wheelchair_t( passedt )
   end
   ...
   if ((  passedt.amenity == "restaurant"       ) and
      ...
      passedt.amenity = "restaurant_french_"
      append_wheelchair_t( passedt )
   end

   if ((  passedt.amenity == "restaurant"            ) and
       (  passedt.cuisine == "seafood"               )) then
      passedt.amenity = "restaurant_seafood_"
      append_wheelchair_t( passedt )
   end
...
-- ----------------------------------------------------------------------------
   ...
   if ((( passedt.leisure    == nil             )   or
        ( passedt.leisure    == ""              ))  and
       (  passedt.playground == "playhouse"      )) then
      passedt.amenity = "playground_playhouse"
   end
...
-- ----------------------------------------------------------------------------
-- Handle disused railways, however tagged
-- ----------------------------------------------------------------------------
   if ((  passedt["disused:railway"] == "rail"  ) and
       (( passedt.building         == nil      )  or
        ( passedt.building         == ""       )) and
       (( passedt.highway          == nil      )  or
        ( passedt.highway          == ""       )) and
...
-- ----------------------------------------------------------------------------
   ...
   if ((  passedt["razed:railway"] == "rail"                ) and
       (( passedt.building         == nil                  )  or
        ( passedt.building         == ""                   )) and
       (( passedt.highway          == nil                  )  or
        ( passedt.highway          == ""                   )) and
...
-- ----------------------------------------------------------------------------
   ...
   if ((( passedt.man_made == "spillway"             )  or
        ...
        ( passedt.golf     == "water_hazard"         )  or
        ( passedt.golf     == "lateral_water_hazard" )) and
       (( passedt.natural == nil              )  or
        ( passedt.natural == ""               ))) then
...
-- ----------------------------------------------------------------------------
   if ((   passedt.military == "office"                             ) or
       ...
       (   passedt.hazard   == "sink_holes"                         ) or
       (   passedt.hazard   == "wreck"                              ) or
...
-- ----------------------------------------------------------------------------
   ...
   if ((  passedt.amenity == "fast_food"             )  and
       (  passedt.cuisine == "sandwich"              )) then
      passedt.amenity = "fast_food_sandwich_"
      append_wheelchair_t( passedt )
   end
   ...
   if ((  passedt.amenity == "fast_food"               )  and
       (( passedt.cuisine == "chicken"                )   or
        ( passedt.cuisine == "fried_chicken"          )   or
        ( passedt.cuisine == "wings"                  ))) then
      passedt.amenity = "fast_food_chicken_"
      append_wheelchair_t( passedt )
   end
...
-- ----------------------------------------------------------------------------
   ...
   if ((  passedt.amenity == "fast_food"               ) and
       (( passedt.cuisine == "mexican"                )  or
        ( passedt.cuisine == "tex-mex"                ))) then
      passedt.amenity = "fast_food_mexican_"
      append_wheelchair_t( passedt )
   end
...
-- ----------------------------------------------------------------------------
   if (( passedt.office      == "it"                          ) or
       ...
       ( passedt.shop        == "mobile_industrial_equipment" )) then
      passedt.office     = "nonspecific"
      passedt.landuse    = "unnamedcommercial"
      passedt.amenity    = nil
      passedt.craft      = nil
...
function calculate_sidewalk_edge( passedt )
    if ((   passedt.sidewalk          == "both"                ) or 
        ...
        (   passedt["cycleway:left"]  == "sidepath"            ) or
        (   passedt["cycleway:left"]  == "opposite_track"      ) or
        (   passedt["cycleway:left"]  == "sidewalk"            ) or
        (   passedt["cycleway:left"]  == "yes"                 ) or
        (   passedt["cycleway:right"] == "separate"            ) or
        (   passedt["cycleway:right"] == "track"               ) or
        (   passedt["cycleway:right"] == "share_sidewalk"      ) or
        (   passedt["cycleway:right"] == "shared"              ) or
        (   passedt["cycleway:right"] == "sidepath"            ) or
        (   passedt["cycleway:right"] == "opposite"            ) or
        (   passedt["cycleway:right"] == "opposite_track"      ) or
        (   passedt["cycleway:right"] == "separate track"      ) or
        (   passedt["cycleway:right"] == "sidewalk"            ) or
        (   passedt["cycleway:right"] == "yes"                 ) or
