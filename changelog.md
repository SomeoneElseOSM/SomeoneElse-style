...
Show unique icons for [tourism=zoo](https://taginfo.openstreetmap.org/tags/tourism=zoo#overview) and [tourism=squarium](https://taginfo.openstreetmap.org/tags/tourism=aquarium#overview).
