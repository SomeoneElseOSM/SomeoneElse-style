...
## As yet unreleased
(raster, vector) Treat `natural=moor`, `natural=strait` and `natural=mountain_range` as a geographic place like `cape`, `peninsula` etc. - all treated like `place=locality`.
