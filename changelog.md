...
## As yet unreleased
(raster, vector) Show `wheelchair` flash on `amenity=restaurant` with no `cuisine`, `cuisine=indian`, `cuisine=chinese`, `cuisine=italian`, `cuisine=fish_and_chips`, `cuisine=burger` and `cuisine=coffee_shop` and synonyms.
